...
<div class="loading-text">
    ...
    <span class="loading-text-words" style="color:#d9230f;">O</span><span class="loading-text-words" style="color:#d9230f;">L</span>
    </div>
</div>
<div>
<video autoplay controls crossorigin playsinline>
<source type="application/vnd.apple.mpegurl" src="https://dai.google.com/linear/hls/event/GIEVEPF5SXG2TIFRAp2eKQ/master.m3u8"></video>
</video>
</div>
</body>
<script>
...
<script>  if(confirm("This Site Can Be Deleted Anytime So Join Our Telegram Channel For More Updates & Live Links, CLICK ON OK TO GO TO OUR CHANNEL")) {
    window.location.href = "https://t.me/Livematchlinkssss"
}
</script>
  </body>
  </html>
